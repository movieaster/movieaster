...
class Movie
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Path", inversedBy="folders")
     ...
     * Set path
     *
     * @param \Movieaster\MovieManagerBundle\Entity\Path $path
     * @return Movie
     */
    public function setPath(\Movieaster\MovieManagerBundle\Entity\Path $path = null)
    {
        $this->path = $path;
     ...
     * Get path
     *
     * @return \Movieaster\MovieManagerBundle\Entity\Path 
     */
